...
public class MessageKeys {
    ...
    public static final String USER_IS_LOCKED = "user.get_user_detail_is_locked";
    ...
    public static final String ROLE_DOES_NOT_EXISTS = "user.login.role_does_not_exist";
}
