...
public class WebSecurityConfig {
    ...
    // Xem coi user đã đủ giấy tờ chưa nếu đủ rồi thì cho qua
    // Add filter trước khi authorize (.addFilterBefore(jwtTokenFilter, UsernamePasswordAuthenticationFilter.class))
    @Bean
